...
public class Heladeria extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		double impD = calcularImpoDescuento(impC,cant);
		double impP = calcularimpPagar(impC, impD);
		int Caramelos = obtenerCaramelos(Marca,cant);
	...
	double calcularImpoDescuento(double impC,int cant){
	...
	int obtenerCaramelos(String Marca, int cant){
